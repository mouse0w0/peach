...
public class ViewTab {
    ...
    private ReadOnlyObjectWrapper<com.github.mouse0w0.peach.ui.control.ViewGroup> viewGroup;

    private ReadOnlyObjectWrapper<com.github.mouse0w0.peach.ui.control.ViewGroup> viewGroupPropertyImpl() {
        if (viewGroup == null) {
    ...
    final void setViewGroup(com.github.mouse0w0.peach.ui.control.ViewGroup viewGroup) {
        viewGroupPropertyImpl().set(viewGroup);
    }

    public final ReadOnlyObjectProperty<com.github.mouse0w0.peach.ui.control.ViewGroup> viewGroupProperty() {
        return viewGroupPropertyImpl().getReadOnlyProperty();
    }

    public final com.github.mouse0w0.peach.ui.control.ViewGroup getViewGroup() {
