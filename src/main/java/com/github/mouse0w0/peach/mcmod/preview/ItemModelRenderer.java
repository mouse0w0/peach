...
public final class ItemModelRenderer {
    ...
    public BufferedImage render(Model model,
        ...
        return frameBuffer.getColorTexture().toBufferedImage();
    }

    private static final Matrix4f DEFAULT_TRANSFORM = new Matrix4f()
    ...
    private void setupModelViewProjectionMatrix(Model model) {
        ...
        if (transform != null) {
            ...
            modelMatrix.set(DEFAULT_TRANSFORM);
        }
