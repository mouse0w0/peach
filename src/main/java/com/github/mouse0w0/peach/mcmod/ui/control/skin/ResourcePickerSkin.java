...
public class ResourcePickerSkin extends SkinBase<ResourcePicker> {
    private static final PseudoClass FOCUSED = PseudoClass.getPseudoClass("focused");

    private final TextField editor;
    private final StackPane openChooserBtn;

    public ResourcePickerSkin(ResourcePicker control) {
        super(control);
        ...
        editor.textProperty().bind(Bindings.createStringBinding(control::getResourcePath, control.filePathProperty(), control.hideExtensionProperty()));
