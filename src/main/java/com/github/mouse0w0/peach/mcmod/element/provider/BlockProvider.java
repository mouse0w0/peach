...
public class BlockProvider extends ElementProvider<BlockElement> {
    ...
    public void index(Project project, BlockElement element, Indexer indexer) {
        ...
        List<ItemData> itemDataList = ImmutableList.of(new ItemData(itemId, 0, 64, 0, true, element.getDisplayName(), PreviewManager.getInstance(project).getBlockImage(element)));
