...
public class BlockWallBase extends ClassGenerator {
    public BlockWallBase(String className) {
        ...
        }
        {
            ...
            mv.visitInsn(DUP);
            mv.visitLdcInsn(Double.valueOf("0.25"));
            mv.visitInsn(DCONST_0);
            mv.visitLdcInsn(Double.valueOf("0.25"));
            mv.visitLdcInsn(Double.valueOf("0.75"));
            ...
            mv.visitTypeInsn(NEW, "net/minecraft/util/math/AxisAlignedBB");
            mv.visitInsn(DUP);
            mv.visitLdcInsn(Double.valueOf("0.3125"));
            mv.visitInsn(DCONST_0);
            mv.visitInsn(DCONST_0);
            mv.visitLdcInsn(Double.valueOf("0.6875"));
            mv.visitLdcInsn(Double.valueOf("0.875"));
            mv.visitInsn(DCONST_1);
            mv.visitMethodInsn(INVOKESPECIAL, "net/minecraft/util/math/AxisAlignedBB", "<init>", "(DDDDDD)V", false);
            mv.visitInsn(AASTORE);
            mv.visitInsn(DUP);
            ...
            mv.visitInsn(ICONST_0);
            mv.visitInsn(AALOAD);
            mv.visitLdcInsn(Double.valueOf("1.5"));
