...
public class ViewPane extends Control {
    ...
    public ViewPane() {
        ...
        getViewGroups().addListener(new ListChangeListener<>() {
            ...
            public void onChanged(Change<? extends com.github.mouse0w0.peach.javafx.control.ViewGroup> c) {
                while (c.next()) {
                    if (c.wasRemoved()) {
                        for (com.github.mouse0w0.peach.javafx.control.ViewGroup viewGroup : c.getRemoved()) {
                    ...
                    if (c.wasAdded()) {
                        for (com.github.mouse0w0.peach.javafx.control.ViewGroup viewGroup : c.getAddedSubList()) {
                            viewGroup.setViewPane(ViewPane.this);
                            EightPos pos = viewGroup.getPos();
                            com.github.mouse0w0.peach.javafx.control.ViewGroup oldViewGroup = getViewGroupImpl(pos);
    ...
    private final com.github.mouse0w0.peach.javafx.control.ViewGroup[] cacheViewGroups = new com.github.mouse0w0.peach.javafx.control.ViewGroup[8];
    private final ObservableList<com.github.mouse0w0.peach.javafx.control.ViewGroup> viewGroups = FXCollections.observableArrayList();

    public final ObservableList<com.github.mouse0w0.peach.javafx.control.ViewGroup> getViewGroups() {
        return viewGroups;
    }

    public final com.github.mouse0w0.peach.javafx.control.ViewGroup getViewGroup(EightPos pos) {
        com.github.mouse0w0.peach.javafx.control.ViewGroup viewGroup = getViewGroupImpl(pos);
        if (viewGroup == null) {
            viewGroup = new com.github.mouse0w0.peach.javafx.control.ViewGroup(pos);
