...
- 【MC模组】更多项目元数据支持。
- 【MC模组】创造标签：搜索栏、背景图。√
- 【MC模组】物品属性：物品耐久、破坏速度、破坏任何方块、附魔能力、合成物品保留、附加信息、修复物品、装备槽、可接受附魔、使用时长、使用动画、击中实体损耗、破坏方块损耗。
- 【MC模组】物品类型：方块物品（方块）、近战武器、工具（工具类型、工具等级）、燃料（燃烧时间）、食物（营养值、饱食度、狼的食物、食品容器、总是可食用）、盔甲（盔甲贴图，装备音效）。
- 【MC模组】物品属性修饰：最大生命、击退抗性、移动速度、飞行速度、攻击伤害、攻击速度、防御点数、盔甲韧性、幸运、交互距离、游泳速度。
- 【MC模组】方块属性：注册名、显示名、方块预设、材质、创造标签、声音、硬度、爆炸抗性、滑度、亮度、透光度、受重力影响、碰撞箱、无碰撞、不可破坏、可替换、附加信息。
- 【MC模组】方块预设：柱体、四向（朝向玩家）、四向（背向玩家）、六向（朝向玩家）、六向（背向玩家）、楼梯、半砖、栅栏、栅栏门、墙、活板门、地毯、玻璃板、梯子、植物。
- 【MC模组】方块高级属性：地图颜色、信标光柱颜色、信标基座、红石连接、植物土壤、附魔加成、可燃性、火焰传播性、活塞推动、AI路点。
- 【MC模组】方块外观：模型、贴图、物品贴图、粒子贴图、渲染类型、透明方块、链接面检查、随机模型偏移。
- 【MC模组】方块世界生成：矿物、植物。
- 【MC模组】自定义模型。
- 【MC模组】合成配方配方组与命名空间。
- 【编译器】独立编译器模块。
